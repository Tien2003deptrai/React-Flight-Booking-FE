        ...
        <>
            <div className='flex w-full pb-20 md:px-[200px] px-8 flex-col gap-16 justify-center items-center'>
                <div className='flex flex-col w-full items-center'>
                    ...
                    <span className='font-semibold text-slate-700 text-3xl mt-1'>Our Latest Post</span>
                    <p className='max-w-[400px] text-center mt-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum quasi totam quidem voluptas sit dolor iusto illo? Quos sapiente voluptas laboriosam vitae fugiat assumenda laudantium autem ea, amet, reprehenderit vero!</p>
                </div>
                        ...
                        posts.map((post) => {
                            return (
                                <div
                                    ...
                                    style={{ boxShadow: '0 0 40px 5px rgba(0 0 0 / 5%)' }}
                                >
                                    <img src={post.image}
                                        alt={post.title}
